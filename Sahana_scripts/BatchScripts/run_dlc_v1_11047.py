...
basepath = '/xdisk/barnesca/sahanasrivathsa/Deeplabcut/VideosToAnalyze/11047'
...
deeplabcut.analyze_videos(config, [video], shuffle=shuffle, videotype=vtype,destfolder=dest_folder)
