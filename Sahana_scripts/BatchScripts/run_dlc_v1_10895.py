...
basepath = '/xdisk/barnesca/sahanasrivathsa/Deeplabcut/VideosToReAnalyze/10895'
...
deeplabcut.analyze_videos(config, [video], shuffle=shuffle, videotype=vtype, save_as_csv=True,destfolder=dest_folder)
