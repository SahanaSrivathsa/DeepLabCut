...
input_dir = r"G:\WMAZE_Data\Data_Ephys\10894\Session21\PositionData\NewSplitPosTest\10894\split_output"  # Change to your directory
os.chdir(input_dir)
#Make directory for merged files
merged_dir = os.path.join(input_dir, "Merged2")
